...
//!
//! [`VirtioRng::new`] nimmt einen Funktionszeiger. Der naheliegende Weg waere
...
/// Aufgelöste Adressen der virtio-Strukturen (im BAR, Device-gemappt).
///
...
impl VirtioRng {
    ...
    pub const fn new(common: u64, notify_base: u64, notify_mul: u32, fence: fn()) -> Self {
        Self { common, notify_base, notify_mul, fence }
    }
}
