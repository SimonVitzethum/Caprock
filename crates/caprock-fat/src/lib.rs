...
//!
//! Wie `caprock-part` haengt diese Crate an **nichts** und wird von einer Userland-PD gelinkt.
...
/// soll es nicht wissen — das ist die Aufgabe der Partitionstabelle (`caprock-part`). Zwei
