...
ZIELE="${*:-mem part fat cycles loader cap virtio dma wait irte irteneg grossdmaneg dmar dmarneg typestate ipctreue}"
for z in $ZIELE; do
    case "$z" in
        ...
        *)    echo "  FEHLER: unbekanntes Ziel '$z' (bekannt: mem part fat cycles loader cap virtio dma wait irte irteneg grossdmaneg dmar dmarneg typestate ipctreue)"; fail=1 ;;
    esac
done
